...
flags.DEFINE_integer("iterations", 1000, "Number of training iterations.")
...
def main(argv):
    ...
    game = pyspiel.load_game(
        FLAGS.game, {"players": 2}) # {"players": pyspiel.GameParameter(FLAGS.players)})
    ...
    with tf.Session() as sess:
        ...
        for i in range(deep_cfr_solver._num_iterations):
            if i % FLAGS.logfreq == 0: # evaluation rounds
