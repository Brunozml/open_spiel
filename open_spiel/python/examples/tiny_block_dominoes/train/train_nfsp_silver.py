...
"""NFSP agents trained on python block dominoes. Uses same parameters as  those for Limit Texas Hold'em."""
...
flags.DEFINE_integer("num_players", 2,
                     "Number of players.")
flags.DEFINE_integer("num_train_episodes", int(35e6),
                     "Number of training episodes.")
flags.DEFINE_integer("eval_every", 10_0000,
                     "Episode frequency at which the agents are evaluated.")
flags.DEFINE_integer("save_every", 10_000,
                     "Episode frequency at which the agents are saved.")
flags.DEFINE_string("checkpoint_dir", "open_spiel/python/examples/tiny_block_dominoes/agents/nfsp/silver_", 
...
flags.DEFINE_integer("replay_buffer_capacity", int(600_00),
                     "Size of the replay buffer.")
flags.DEFINE_integer("reservoir_buffer_capacity", int(30e6),
...
flags.DEFINE_integer("learn_every", 256,
                     "Number of steps between learning updates.")
flags.DEFINE_float("rl_learning_rate", 0.1,
...
flags.DEFINE_integer("epsilon_decay_duration", int(35e7),
...
def log_info(ep, expl) -> dict[str, list[Union[float, str]]]:
  logging.info(f"{(ep+1)/FLAGS.num_train_episodes*100:.2f}% [{ep+1}] Exploitability AVG {expl}")
  return {
    "Iteration": [ep+1],
    "Exploitability": [expl]
  }
