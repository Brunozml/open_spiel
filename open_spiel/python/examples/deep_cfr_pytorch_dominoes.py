...
"""Python Deep CFR example for 2 player block dominoes."""
...
def main(unused_argv):
  ...
  logging.info("Solver time taken: %s seconds", solver_time - start_time)

  logging.info("Computing average policy.")

  average_policy = policy.tabular_policy_from_callable(
      game, deep_cfr_solver.action_probabilities)
  pyspiel_policy = policy.python_policy_to_pyspiel_policy(average_policy)

  logging.info("Computing NashConv.")
