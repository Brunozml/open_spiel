...
def main(_):
  ...
  with tf.Session() as sess:
    ...
    for ep in range(FLAGS.num_train_episodes):
      if (ep + 1) % FLAGS.eval_every == 0:
        ...
        plt.legend()
        plt.savefig(f'open_spiel/python/examples/saved_examples/{game}_reward_plot_dqn.png')
  ...
  # After training, log and plot the rewards
  logging.info("Rewards: %s", rewards)
  plt.plot(rewards)
  plt.xlabel('Training Iterations')
  plt.ylabel('Reward')
  plt.title('Reward vs Training Iterations')
  plt.savefig('open_spiel/python/examples/saved_examples/breakthrough_reward_plot.png')
