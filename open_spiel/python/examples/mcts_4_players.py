...
flags.DEFINE_string("game", "python_tiny_dominoes", "Name of the game.")
...
def main(argv):
  ...
  if game.num_players() != 4:
    sys.exit("This game requires more/less than 4 players.")
  bots = [
  ...
  print("Players:", FLAGS.player1, FLAGS.player2, FLAGS.player2, FLAGS.player3)
