...
flags.DEFINE_integer("num_traversals", 40, "Number of traversals/games") # used to be 40
...
def plot_rewards(rewards):
            ...
            plt.legend()
            plt.savefig(f'open_spiel/python/examples/saved_examples/{FLAGS.game}_reward_plot_deepcfr.png')
